...
from core.album_categories import CATEGORIAS_ALBUM, categoria_para_palabra_generica, palabra_para_display
...
class AssetManager:
    ...
    def obtener_genericos_por_categoria(categoria):
        ...
        cuya primera palabra del nombre de archivo coincide con la categoría.
        """
        ...
        for ruta in AssetManager._listar_genericos():
            ...
            if categoria_para_palabra_generica(palabra) == categoria:
